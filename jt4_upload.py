# -*- coding: utf-8 -*-
# March-May  2020 This version for jt4 data Oct-Nov 2024  Gwyn Griffiths G3ZIL
# jt4_upload.py   a program to read in jt4 spots and extended data file and upload to a TimescaleDB
...
# Version 1.3 Nov 2024 for jt4 24 GHz WebSDR and Raspberry Pi installation
...
try:
    with open (batch_file_path) as csv_file:
        ...
        sql="""INSERT INTO jt4 (time, tx_call, tx_grid, band, frequency, snr, dt, distance, tx_azi, tx_lat, tx_lon, rx_id,
        rx_grid, rx_lat, rx_lon, rx_azi, mode)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
        try:
               # connect to the PostgreSQL database
               #print ("Trying to  connect")
               conn = psycopg2.connect("dbname='tutorial' user='wdupload' host='wd2.wsprdaemon.org' password='Whisper2008'")
               connected="Connected"
